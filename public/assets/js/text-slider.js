(function ( $ ) {
	...
	$.fn.textSlider = function ( options ) {
		...
		function firstSlide ()
		{
			...
			$('.slide-' + currentItem ).show().animate({ paddingTop: '80px', paddingBottom: '50px', opacity: 1 }, settings.slideTime);
		...
		function transition ()
		{
			...
			$('.slide-' + currentItem ).animate({ paddingTop: '100px', paddingBottom: '0px', opacity: 0 }, settings.slideTime, function () {
				$(this).hide();
				$('.slide-' + nextItem ).show().animate({ paddingTop: '80px', paddingBottom: '50px', opacity: 1 }, settings.slideTime);
			});
